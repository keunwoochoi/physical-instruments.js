...
| Report identity | none | schema `1.0.0`, metric `2026.07.12-l1`, input SHA-256, runtime/config/operation provenance | Results can now be attributed to exact audio and metric semantics. |
