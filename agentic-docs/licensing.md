...
| virtuosity-drums (github.com/studiorack/virtuosity-drums) | CC0-1.0 (verified) | ride + hi-hat measurement targets for the cymbal engine and jazz-kick close/mid/overhead velocity references (scratchpad only) | not committed; CC0 = no attribution required (provenance kept anyway) |
