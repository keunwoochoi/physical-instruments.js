...
| A43's Drum Kit, Freesound pack 532 (A43; sounds 9697, 9698, 9780, 9877, 9878, 11378; fetched 2026-07-12) | Sampling+ 1.0 (verified on every sound page) | Original Roland TR-808 isolated maraca, short kick, cowbell, closed/open hats, and snare; tune/voice-held-out measurement only (scratchpad). The pages explicitly identify the hardware and recording path, but also disclose Akai S5000 or Bias Peak editing/processing. The staged files are public Freesound HQ MP3 previews because lossless downloads require login; canonicalization decodes to mono 48 kHz PCM, prepends 30 ms, and pads silence to 2.5 s. Source and canonical digests are recorded in issue #29 evidence. | not committed; do not redistribute; Sampling+ attribution would be required for a transformed work and whole-sound distribution is noncommercial-only |
| `808patterns 01.ogg` (Theofanis Siassios, Wikimedia Commons; fetched 2026-07-12) | CC-BY-SA-3.0 (verified on the Commons file page; permission confirmed through Wikimedia VRT) | Independent original-hardware TR-808 pattern recording for held-out arrangement listening only (scratchpad); not an isolated-voice fitting source. Download SHA-256 `95def1464052631134d7f71f2a157ea23aea47b614237d672ab1d3ab184b46ac`. | not committed; attribution and ShareAlike apply if redistributed |
