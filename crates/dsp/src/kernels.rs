...
pub fn makeup_gain(inst: Instrument) -> f32 {
    ...
    match inst {
        ...
        Instrument::Drums => 0.61,        // drums r4 re-bake (kick de-tonality bed + hat/ride work, was -21.0)
        ...
        Instrument::DrumsRock => 0.41,      // drums r4 re-bake (own snare/toms/hats/crash, was -21.7)
        Instrument::DrumsJazz => 0.56,      // drums r4 re-bake (brush kit + subtle kick, ran +0.6 LU)
    }
}
